...
│   │   ├── services/            # Core services (auth, data, security)
...
│   │
│   ├── recruiter/                # Recruiter portal module
│   │   ├── job-posting/         # Job posting management
│   │   ├── interview-scheduler/ # Interview scheduling
│   │   ├── candidate-management/# Candidate profiles and tracking
│   │   └── recruiter.module.ts  # Recruiter module
│   │
│   ├── applicant/                # Applicant portal module
│   │   ├── job-search/          # Job search and filtering
│   │   ├── application-tracker/ # Application status tracking
│   │   ├── profile/             # Applicant profile management
│   │   └── applicant.module.ts  # Applicant module
│   │
